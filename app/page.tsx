...
const produits = [
  {
    ...
    description: 'Cochinita, Carnitas, Pastor, Asada de Bœuf, Pollo Azteca, Pescado, Végétariens — 7 garnitures sur tortillas pressées à la main, cuisson minute.',
    sensations: ['7 garnitures', 'Tortilla maison', '4 pièces'],
    couleur: '#c0392b',
  },
  {
    emoji: '🫔',
    nom: 'Tamales & Burritos',
    description: 'Tamales en feuille de banane (Rojos, Verdes, Mole, Chile Poblano) et Burritos généreux roulés dans une tortilla de farine.',
    sensations: ['Feuille de banane', 'Recette ancestrale', 'Généreux'],
    couleur: '#d35400',
  },
  {
    emoji: '🍹',
    nom: 'Boissons mexicaines',
    description: 'Margarita, Paloma, Jarritos, Aguas mexicaines, vins, bières artisanales Mayahuel & Floral — de quoi accompagner chaque repas.',
    sensations: ['Cocktails', 'Jarritos', 'Vins & bières'],
    couleur: '#2d6a4f',
  },
];
